...
import ShowCandid from "./ShowCandid";
    ...
    <div className="Candidature">
      <div className="Candidature-content">
        ...
        <div className="filter d-flex">
          ...
          <div>
            <span className="subcategory">Candidature</span>
          </div>
        </div>
        ...
        <div className="search pe-3">
          <div className="d-flex align-items-center">
            <h4 style={{ fontWeight: "700", marginLeft: "1rem" }}>
              La liste des candidatures reçus
            </h4>
          </div>
        ...
        {/* Show Candidature Component */}
        <ShowCandid sortOption={sortOption} searchTerm={searchTerm} />
      </div>
    </div>
  );
};
