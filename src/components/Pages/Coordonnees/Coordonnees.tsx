...
import ShowCoordonnees from "./ShowCoordonnees";
...
const Coordonnees: React.FC = () => {
  ...
  return (
    <div className="coordonnees">
      <div className="coordonnees-content">
        <div className="filter d-flex">
          ...
          <div>
            <span className="subcategory">Coordonnées</span>
          </div>
        </div>
        ...
        <div className="Btn-add-container">
          <Link to={"/coordonnees/add-blog"} className="add-medecins">
            <span>Ajouter un article</span>
            <BiPlus className="addmedecin-icon" />
          </Link>
        </div>
        <ShowCoordonnees sortOption={sortOption} searchTerm={searchTerm} />
      </div>
    </div>
  );
};
