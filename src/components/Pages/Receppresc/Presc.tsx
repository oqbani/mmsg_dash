...
import ShowPresc from "./ShowPresc";
    ...
    <div className="Presc">
      <div className="Presc-content">
        ...
        <div className="filter d-flex">
          ...
          <div>
            <span className="subcategory">Prescription</span>
          </div>
        </div>
        ...
        <div className="search pe-3">
          <div className="d-flex align-items-center">
            <h4 style={{ fontWeight: "700", marginLeft: "1rem" }}>
              La liste des prescription reçus
            </h4>
          </div>
        ...
        {/* Show Presc Component */}
        <ShowPresc sortOption={sortOption} searchTerm={searchTerm} />
      </div>
    </div>
  );
};
